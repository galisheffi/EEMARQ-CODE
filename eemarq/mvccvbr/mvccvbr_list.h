...
public:
    ...
    ~mvccvbr_list() {
      ...
      cout << "Initial num caches = " << globalAllocator->getInitialNumCaches() << endl; 
      ...
      cout << "Index initial num caches = " << index->getInitialNumCaches() << endl;
      ...
      cout << "Index initial num caches = " << treeIndex->getInitialNumCaches() << endl;
